        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Specialists in energy and infrastructure recruitment and talent acquisition across engineering and technology sectors. Operating in the USA, UK, and Europe.
            </p>
            ...
            <ul className="space-y-3 text-slate-600">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  <a href="tel:+447399836007" className="block hover:text-blue-600 transition-colors">07399 836 007 <span className="text-slate-500">(UK)</span></a>
                  <a href="tel:+17865791193" className="block hover:text-blue-600 transition-colors">+1 (786) 579-1193 <span className="text-slate-500">(US)</span></a>
                </div>
              </li>
            </ul>
          </div>
